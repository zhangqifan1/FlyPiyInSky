...
import com.as.flypiyinsky.thelibrary.BaseUtils.android_util_code.util.TUtil;
...
public abstract class BaseMvpActivity<P extends BasePresenter, M extends BaseIModel, B extends ViewDataBinding> extends MyBaseActivity implements BaseIView {
