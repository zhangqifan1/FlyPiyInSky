package com.as.flypiyinsky.thelibrary._baseApp;

import android.app.Application;

import com.as.flypiyinsky.thelibrary.BaseUtils.android_util_code.util.Utils;
import com.as.flypiyinsky.thelibrary.DataBaseGD.MySQLiteOpenHelper;
import com.as.flypiyinsky.thelibrary._baseApp.Album.MediaLoader;
...
//        daoSession = daoMaster.newSession();
        MySQLiteOpenHelper helper = new MySQLiteOpenHelper(this, "music.db",
                null);
        daoSession = new DaoMaster(helper.getEncryptedWritableDb("QWERasdf12345678")).newSession();
    }
