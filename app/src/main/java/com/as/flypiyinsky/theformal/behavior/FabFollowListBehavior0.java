package com.as.flypiyinsky.theformal.behavior;
...
public class FabFollowListBehavior0 extends CoordinatorLayout.Behavior<FloatingActionButton> {
    private static final int MIN_DY = 30;
    private static final String TAG = "FabFollowListBehavior0";
 
    public FabFollowListBehavior0(Context context, AttributeSet attributeSet) {
